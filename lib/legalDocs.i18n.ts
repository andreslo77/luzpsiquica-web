      ...
      sections: [
        ...
        },
        {
          ...
          body:
            ...
            "Luz Psíquica podrá otorgar minutos promocionales de bienvenida a nuevos usuarios como beneficio inicial de prueba. Estos minutos promocionales son asignados una sola vez por usuario y/o dispositivo compatible, y no son transferibles, reembolsables ni canjeables por dinero.\n\n" +
            "Con el fin de proteger la integridad de la plataforma, Luz Psíquica podrá implementar mecanismos técnicos de validación, incluyendo verificación de dispositivo, actividad de cuenta, patrones de uso y otros controles antifraude.\n\n" +
            "Si se detectan intentos de duplicación, manipulación o abuso del sistema, Luz Psíquica podrá suspender, limitar o revocar dichos beneficios sin previo aviso.\n",
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            ...
            "Luz Psíquica may grant promotional welcome minutes to new users as an initial trial benefit. These promotional minutes are assigned only once per user and/or compatible device and are non-transferable, non-refundable, and cannot be exchanged for cash.\n\n" +
            "To protect the integrity of the platform, Luz Psíquica may implement technical validation mechanisms, including device verification, account activity monitoring, usage pattern analysis, and other anti-fraud controls.\n\n" +
            "If duplication attempts, system manipulation, or abusive behavior are detected, Luz Psíquica reserves the right to suspend, limit, or revoke promotional benefits without prior notice.\n",
        },
        {
